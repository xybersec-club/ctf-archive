...
public abstract class AbstractDoubleTimeSource implements TimeSource {
    ...
    private static final class DoubleTimeMark implements TimeMark {
        ...
        public TimeMark mo1352minusLRDsOJo(long j) {
            return TimeMark.DefaultImpls.m1494minusLRDsOJo(this, j);
        }
        ...
        public TimeMark mo1353plusLRDsOJo(long j) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1395plusLRDsOJo(this.offset, j), null);
        }
    }

    @Override // kotlin.time.TimeSource
    public TimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m1461getZEROUwyO8pc(), null);
    }
}
