...
public final class InlineList<E> {
    ...
    public static final Object m1577plusFjFbRPM(Object obj, E e) {
        if (!DebugKt.getASSERTIONS_ENABLED() || (!(e instanceof List))) {
            ...
            arrayList.add(obj);
            arrayList.add(e);
            return m1571constructorimpl(arrayList);
        }
        throw new AssertionError();
    }

    /* renamed from: forEachReversed-impl  reason: not valid java name */
    public static final void m1575forEachReversedimpl(Object obj, Function1<? super E, Unit> function1) {
        if (obj == null) {
            return;
        }
        if (!(obj instanceof ArrayList)) {
