    ...
    */
    ...
    private final void helpClose(Closed<?> closed) {
        ...
        while (true) {
            ...
            if (receive == null) {
                break;
            } else if (!receive.mo1580remove()) {
                receive.helpRemove();
            } else {
                m1572constructorimpl$default = InlineList.m1577plusFjFbRPM(m1572constructorimpl$default, receive);
            }
        }
        if (m1572constructorimpl$default != null) {
            if (!(m1572constructorimpl$default instanceof ArrayList)) {
                ((Receive) m1572constructorimpl$default).resumeReceiveClosed(closed);
            } else if (m1572constructorimpl$default != null) {
                ArrayList arrayList = (ArrayList) m1572constructorimpl$default;
