...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    */
    public final java.lang.Object mo1533receiveCatchingJP2dKIU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r5) {
        /*
            r4 = this;
        ...
        L32:
            ...
            java.lang.Object r4 = r4.m1553closedJP2dKIU(r5)
            goto L52
        L4c:
            kotlinx.coroutines.channels.ChannelResult$Companion r4 = kotlinx.coroutines.channels.ChannelResult.Companion
            java.lang.Object r4 = r4.m1555successJP2dKIU(r5)
        L52:
            return r4
        L53:
            r0.label = r3
    ...
    public final Object mo1534tryReceivePtdJZtk() {
        Object pollInternal = pollInternal();
        return pollInternal == AbstractChannelKt.POLL_FAILED ? ChannelResult.Companion.m1554failurePtdJZtk() : pollInternal instanceof Closed ? ChannelResult.Companion.m1553closedJP2dKIU(((Closed) pollInternal).closeCause) : ChannelResult.Companion.m1555successJP2dKIU(pollInternal);
    }
    ...
    public void onCancelIdempotent(boolean z) {
        ...
        Object m1572constructorimpl$default = InlineList.m1572constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (!(prevNode instanceof LockFreeLinkedListHead)) {
                ...
                if (!prevNode.mo1580remove()) {
                    prevNode.helpRemove();
                } else {
                    m1572constructorimpl$default = InlineList.m1577plusFjFbRPM(m1572constructorimpl$default, (Send) prevNode);
                }
            } else {
                mo1532onCancelIdempotentListww6eGU(m1572constructorimpl$default, closedForSend);
                return;
            }
        }
    }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) {
        ...
        if (!z) {
            if (i == 1) {
                UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1540boximpl(z ? ChannelResult.Companion.m1553closedJP2dKIU(((Closed) obj).closeCause) : ChannelResult.Companion.m1555successJP2dKIU(obj)), selectInstance.getCompletion());
            } else {
            ...
            while (true) {
                ...
                if (pollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        cancellableContinuationImpl.resumeWith(Result.m44constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                    }
    ...
    public static class ReceiveElement<E> extends Receive<E> {
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                Result.Companion companion = Result.Companion;
                this.cont.resumeWith(Result.m44constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                return;
            }
            Result.Companion companion2 = Result.Companion;
            this.cont.resumeWith(Result.m44constructorimpl(ChannelResult.m1540boximpl(ChannelResult.Companion.m1553closedJP2dKIU(closed.closeCause))));
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m1540boximpl(ChannelResult.Companion.m1553closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                }
            }
        }
    ...
    protected void mo1532onCancelIdempotentListww6eGU(Object obj, Closed<?> closed) {
        if (obj == null) {
            return;
        }
