...
public final class DispatchedContinuationKt {
    ...
    public static final <T> void resumeCancellableWith(Continuation<? super T> continuation, Object obj, Function1<? super Throwable, Unit> function1) {
        ...
        if (dispatchedContinuation.dispatcher.isDispatchNeeded(dispatchedContinuation.getContext())) {
            ...
            dispatchedContinuation.dispatcher.mo1639dispatch(dispatchedContinuation.getContext(), dispatchedContinuation);
            return;
        }
        ...
        try {
            ...
            if (job == null || job.isActive()) {
                ...
                dispatchedContinuation.resumeWith(Result.m102constructorimpl(ResultKt.createFailure(cancellationException)));
                z = true;
            }
            if (!z) {
