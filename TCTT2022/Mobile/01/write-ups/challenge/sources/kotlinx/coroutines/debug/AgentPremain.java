...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m102constructorimpl = Result.m102constructorimpl(property == null ? null : Boolean.valueOf(Boolean.parseBoolean(property)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m102constructorimpl = Result.m102constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = Result.m108isFailureimpl(m102constructorimpl) ? null : m102constructorimpl;
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1615installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1615installSignalHandler$lambda1(Signal signal) {
