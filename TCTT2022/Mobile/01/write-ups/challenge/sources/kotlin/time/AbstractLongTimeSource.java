...
public abstract class AbstractLongTimeSource implements TimeSource {
    ...
    private static final class LongTimeMark implements TimeMark {
        ...
        public TimeMark mo1411plusLRDsOJo(long j) {
            return new LongTimeMark(this.startedAt, this.timeSource, Duration.m1453plusLRDsOJo(this.offset, j), null);
        }
    }

    @Override // kotlin.time.TimeSource
    public TimeMark markNow() {
        return new LongTimeMark(read(), this, Duration.Companion.m1519getZEROUwyO8pc(), null);
    }
}
