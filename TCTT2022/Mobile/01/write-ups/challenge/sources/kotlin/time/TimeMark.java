...
public interface TimeMark {
    ...
    TimeMark mo1410minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1411plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1553plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m1552minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1411plusLRDsOJo(Duration.m1469unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1450isNegativeimpl(timeMark.mo1409elapsedNowUwyO8pc());
        }
