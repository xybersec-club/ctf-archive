...
public final class InlineList<E> {
    ...
    public static final /* synthetic */ InlineList m1628boximpl(Object obj) {
        return new InlineList(obj);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static <E> Object m1629constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1631equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof InlineList) && Intrinsics.areEqual(obj, ((InlineList) obj2).m1637unboximpl());
    }
    ...
    public int hashCode() {
        return m1634hashCodeimpl(this.holder);
    }

    public String toString() {
        return m1636toStringimpl(this.holder);
    }
    ...
    public static /* synthetic */ Object m1630constructorimpl$default(Object obj, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            obj = null;
        }
        return m1629constructorimpl(obj);
    }

    /* renamed from: plus-FjFbRPM  reason: not valid java name */
    public static final Object m1635plusFjFbRPM(Object obj, E e) {
        if (!DebugKt.getASSERTIONS_ENABLED() || (!(e instanceof List))) {
            if (obj == null) {
                return m1629constructorimpl(e);
            }
            ...
            arrayList.add(obj);
            arrayList.add(e);
            return m1629constructorimpl(arrayList);
        }
        throw new AssertionError();
    }

    /* renamed from: forEachReversed-impl  reason: not valid java name */
    public static final void m1633forEachReversedimpl(Object obj, Function1<? super E, Unit> function1) {
        if (obj == null) {
            return;
        }
        if (!(obj instanceof ArrayList)) {
