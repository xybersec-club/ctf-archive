...
public final class ResumeAwaitOnCompletion<T> extends JobNode {
    ...
    public void invoke2(Throwable th) {
        ...
        if (state$kotlinx_coroutines_core instanceof CompletedExceptionally) {
            ...
            this.continuation.resumeWith(Result.m102constructorimpl(ResultKt.createFailure(((CompletedExceptionally) state$kotlinx_coroutines_core).cause)));
            return;
        }
        Result.Companion companion2 = Result.Companion;
        this.continuation.resumeWith(Result.m102constructorimpl(JobSupportKt.unboxState(state$kotlinx_coroutines_core)));
    }
}
