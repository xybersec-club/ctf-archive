...
public interface SendChannel<E> {
    ...
    Object mo1593trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m1608isSuccessimpl(mo1593trySendJP2dKIU)) {
                return true;
            }
            Throwable m1602exceptionOrNullimpl = ChannelResult.m1602exceptionOrNullimpl(mo1593trySendJP2dKIU);
            if (m1602exceptionOrNullimpl == null) {
                return false;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m1602exceptionOrNullimpl);
        }
    }
}
