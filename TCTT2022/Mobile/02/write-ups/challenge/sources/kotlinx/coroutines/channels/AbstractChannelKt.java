...
public final class AbstractChannelKt {
    ...
    private static final <E> Object toResult(Object obj) {
        return obj instanceof Closed ? ChannelResult.Companion.m1611closedJP2dKIU(((Closed) obj).closeCause) : ChannelResult.Companion.m1613successJP2dKIU(obj);
    }

    private static final <E> Object toResult(Closed<?> closed) {
        return ChannelResult.Companion.m1611closedJP2dKIU(closed.closeCause);
    }
}
