...
public final class UIntArrayKt {
    ...
    private static final int[] m266uintArrayOfajY9A(int... elements) {
    ...
    private static final int[] UIntArray(int i, Function1<? super Integer, UInt> init) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            iArr[i2] = init.invoke(Integer.valueOf(i2)).m247unboximpl();
        }
        return UIntArray.m250constructorimpl(iArr);
    }
}
