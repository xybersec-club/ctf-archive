...
public abstract class AbstractDoubleTimeSource implements TimeSource {
    ...
    private static final class DoubleTimeMark implements TimeMark {
        ...
        public TimeMark mo1410minusLRDsOJo(long j) {
            return TimeMark.DefaultImpls.m1552minusLRDsOJo(this, j);
        }

        @Override // kotlin.time.TimeMark
        /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
        public long mo1409elapsedNowUwyO8pc() {
            return Duration.m1452minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public TimeMark mo1411plusLRDsOJo(long j) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1453plusLRDsOJo(this.offset, j), null);
        }
    }

    @Override // kotlin.time.TimeSource
    public TimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m1519getZEROUwyO8pc(), null);
    }
}
