...
public final class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1569copyRFiDyg4$default(TimedValue timedValue, Object obj, long j, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m1571copyRFiDyg4(obj, j);
    }
    ...
    public int hashCode() {
        T t = this.value;
        return ((t == null ? 0 : t.hashCode()) * 31) + Duration.m1445hashCodeimpl(this.duration);
    }

    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((Object) Duration.m1466toStringimpl(this.duration)) + ')';
    }
