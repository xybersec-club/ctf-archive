...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> collection) {
        ...
        byte[] m171constructorimpl = UByteArray.m171constructorimpl(collection.size());
        int i = 0;
        for (UByte uByte : collection) {
            UByteArray.m182setVurrAj0(m171constructorimpl, i, uByte.m169unboximpl());
            i++;
        }
    ...
    public static final int[] toUIntArray(Collection<UInt> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        int[] m249constructorimpl = UIntArray.m249constructorimpl(collection.size());
        int i = 0;
        for (UInt uInt : collection) {
            UIntArray.m260setVXSXFK8(m249constructorimpl, i, uInt.m247unboximpl());
            i++;
        }
    ...
    public static final long[] toULongArray(Collection<ULong> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        long[] m327constructorimpl = ULongArray.m327constructorimpl(collection.size());
        int i = 0;
        for (ULong uLong : collection) {
            ULongArray.m338setk8EXiF4(m327constructorimpl, i, uLong.m325unboximpl());
            i++;
        }
    ...
    public static final short[] toUShortArray(Collection<UShort> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        short[] m431constructorimpl = UShortArray.m431constructorimpl(collection.size());
        int i = 0;
        for (UShort uShort : collection) {
            UShortArray.m442set01HTLdE(m431constructorimpl, i, uShort.m429unboximpl());
            i++;
        }
        return m431constructorimpl;
    }
