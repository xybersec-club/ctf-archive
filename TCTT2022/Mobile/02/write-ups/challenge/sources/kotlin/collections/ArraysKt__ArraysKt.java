        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m668contentEqualskV0jMPg(((UByteArray) t).m186unboximpl(), ((UByteArray) t2).m186unboximpl())) {
                        return false;
                    }
                    ...
                    if (!UArraysKt.m666contentEqualsKJPZfPQ(((UIntArray) t).m264unboximpl(), ((UIntArray) t2).m264unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m670contentEqualslec5QzE(((ULongArray) t).m342unboximpl(), ((ULongArray) t2).m342unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m682contentToString2csIQuQ(uByteArray != null ? uByteArray.m186unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                sb.append(UArraysKt.m686contentToStringd6D3K8(uShortArray != null ? uShortArray.m446unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                sb.append(UArraysKt.m685contentToStringXUkPCBk(uIntArray != null ? uIntArray.m264unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                sb.append(UArraysKt.m688contentToStringuLth9ew(uLongArray != null ? uLongArray.m342unboximpl() : null));
            } else {
