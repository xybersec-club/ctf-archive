...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    private UIntProgressionIterator(int i, int i2, int i3) {
        ...
        this.hasNext = z;
        this.step = UInt.m196constructorimpl(i3);
        this.next = this.hasNext ? i : i2;
    }

    @Override // java.util.Iterator
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m190boximpl(m1334nextpVg5ArA());
    }
    ...
    public int m1334nextpVg5ArA() {
        ...
        if (i == this.finalElement) {
            ...
            this.next = UInt.m196constructorimpl(this.step + i);
        }
        return i;
    }
}
