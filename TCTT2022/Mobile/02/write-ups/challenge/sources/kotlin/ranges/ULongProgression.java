...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m1316getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }

    /* renamed from: getFirst-s-VKNKU  reason: not valid java name */
    public final long m1338getFirstsVKNKU() {
        return this.first;
    }

    /* renamed from: getLast-s-VKNKU  reason: not valid java name */
    public final long m1339getLastsVKNKU() {
        return this.last;
    }
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return ((int) ((j3 >>> 32) ^ j3)) + (((((int) ULong.m274constructorimpl(j ^ ULong.m274constructorimpl(j >>> 32))) * 31) + ((int) ULong.m274constructorimpl(j2 ^ ULong.m274constructorimpl(j2 >>> 32)))) * 31);
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            append = new StringBuilder().append((Object) ULong.m319toStringimpl(this.first)).append("..").append((Object) ULong.m319toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            append = new StringBuilder().append((Object) ULong.m319toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m319toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1340fromClosedRange7ftBX0g(long j, long j2, long j3) {
