        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m610contentEqualskV0jMPg(((UByteArray) t).m128unboximpl(), ((UByteArray) t2).m128unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m607contentEqualsFGO6Aew(((UShortArray) t).m388unboximpl(), ((UShortArray) t2).m388unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m608contentEqualsKJPZfPQ(((UIntArray) t).m206unboximpl(), ((UIntArray) t2).m206unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m612contentEqualslec5QzE(((ULongArray) t).m284unboximpl(), ((ULongArray) t2).m284unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m624contentToString2csIQuQ(uByteArray != null ? uByteArray.m128unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                sb.append(UArraysKt.m628contentToStringd6D3K8(uShortArray != null ? uShortArray.m388unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                sb.append(UArraysKt.m627contentToStringXUkPCBk(uIntArray != null ? uIntArray.m206unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                sb.append(UArraysKt.m630contentToStringuLth9ew(uLongArray != null ? uLongArray.m284unboximpl() : null));
            } else {
