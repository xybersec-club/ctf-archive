...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int i, int i2, int i3) {
        ...
        this.first = i;
        this.last = UProgressionUtilKt.m1259getProgressionLastElementNkh28Cs(i, i2, i3);
        this.step = i3;
    }
    ...
    public static final class Companion {
        ...
        public final UIntProgression m1275fromClosedRangeNkh28Cs(int i, int i2, int i3) {
