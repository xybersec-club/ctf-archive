...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1<E, R> extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Object m1552unboximpl = ((ChannelResult) this.L$0).m1552unboximpl();
            ...
            Object m1545getOrNullimpl = ChannelResult.m1545getOrNullimpl(m1552unboximpl);
            this.label = 1;
            obj = this.$block.invoke(m1545getOrNullimpl, this);
