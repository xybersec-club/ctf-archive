...
public final class DurationKt {
    ...
    private static final long m1477timesmvk6XK0(int $this$times_u2dmvk6XK0, long duration) {
        return Duration.m1389timesUwyO8pc(duration, $this$times_u2dmvk6XK0);
    }

    /* renamed from: times-kIfJnKk */
    private static final long m1476timeskIfJnKk(double $this$times_u2dkIfJnKk, long duration) {
        return Duration.m1388timesUwyO8pc(duration, $this$times_u2dkIfJnKk);
    }

    /* JADX WARN: Removed duplicated region for block: B:254:0x00c4 A[LOOP:1: B:243:0x0085->B:254:0x00c4, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:389:0x00df A[EDGE_INSN: B:389:0x00df->B:256:0x00df ?: BREAK  , SYNTHETIC] */
    /*
    ...
    */
    ...
    public static final long durationOfNanos(long normalNanos) {
        return Duration.m1351constructorimpl(normalNanos << 1);
    }

    public static final long durationOfMillis(long normalMillis) {
        return Duration.m1351constructorimpl((normalMillis << 1) + 1);
    }

    public static final long durationOf(long normalValue, int unitDiscriminator) {
        return Duration.m1351constructorimpl((normalValue << 1) + unitDiscriminator);
    }
