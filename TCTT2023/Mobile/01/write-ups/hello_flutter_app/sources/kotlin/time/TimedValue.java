...
public final class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1503copyRFiDyg4$default(TimedValue timedValue, Object obj, long j, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m1505copyRFiDyg4(obj, j);
    }
    ...
    public final long m1504component2UwyO8pc() {
        return this.duration;
    }

    /* renamed from: copy-RFiDyg4  reason: not valid java name */
    public final TimedValue<T> m1505copyRFiDyg4(T t, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TimedValue) {
            ...
            return Intrinsics.areEqual(this.value, timedValue.value) && Duration.m1356equalsimpl0(this.duration, timedValue.duration);
        }
        return false;
    }
    ...
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((Object) Duration.m1400toStringimpl(this.duration)) + ')';
    }
    ...
    public final long m1506getDurationUwyO8pc() {
        return this.duration;
    }
