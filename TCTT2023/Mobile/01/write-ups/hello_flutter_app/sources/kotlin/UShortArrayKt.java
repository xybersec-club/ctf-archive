...
public final class UShortArrayKt {
    private static final short[] UShortArray(int size, Function1<? super Integer, UShort> init) {
        ...
        for (int i = 0; i < size; i++) {
            sArr[i] = init.invoke(Integer.valueOf(i)).m365unboximpl();
        }
        return UShortArray.m368constructorimpl(sArr);
    }

    /* renamed from: ushortArrayOf-rL5Bavg  reason: not valid java name */
    private static final short[] m384ushortArrayOfrL5Bavg(short... elements) {
