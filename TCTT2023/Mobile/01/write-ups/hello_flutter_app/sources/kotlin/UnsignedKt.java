...
public final class UnsignedKt {
    ...
    public static final int m385uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m132constructorimpl((int) ((v1 & KeyboardMap.kValueMask) / (KeyboardMap.kValueMask & v2)));
    }

    /* renamed from: uintRemainder-J1ME1BU  reason: not valid java name */
    public static final int m386uintRemainderJ1ME1BU(int v1, int v2) {
        return UInt.m132constructorimpl((int) ((v1 & KeyboardMap.kValueMask) % (KeyboardMap.kValueMask & v2)));
    }

    /* renamed from: ulongDivide-eb3DHEI  reason: not valid java name */
    public static final long m387ulongDivideeb3DHEI(long v1, long v2) {
        if (v2 < 0) {
            return ULong.m210constructorimpl(ulongCompare(v1, v2) >= 0 ? 1L : 0L);
        } else if (v1 >= 0) {
            return ULong.m210constructorimpl(v1 / v2);
        } else {
            long quotient = ((v1 >>> 1) / v2) << 1;
            long rem = v1 - (quotient * v2);
            return ULong.m210constructorimpl((ulongCompare(ULong.m210constructorimpl(rem), ULong.m210constructorimpl(v2)) < 0 ? 0 : 1) + quotient);
        }
    }

    /* renamed from: ulongRemainder-eb3DHEI  reason: not valid java name */
    public static final long m388ulongRemaindereb3DHEI(long v1, long v2) {
        long j = 0;
        if (v2 < 0) {
            ...
            long quotient = ((v1 >>> 1) / v2) << 1;
            long rem = v1 - (quotient * v2);
            if (ulongCompare(ULong.m210constructorimpl(rem), ULong.m210constructorimpl(v2)) >= 0) {
                j = v2;
            }
            return ULong.m210constructorimpl(rem - j);
        }
    }
    ...
    public static final long doubleToULong(double v) {
        if (!Double.isNaN(v) && v > ulongToDouble(0L)) {
            ...
            return v < 9.223372036854776E18d ? ULong.m210constructorimpl((long) v) : ULong.m210constructorimpl(ULong.m210constructorimpl((long) (v - 9.223372036854776E18d)) - Long.MIN_VALUE);
        }
        return 0L;
    }
