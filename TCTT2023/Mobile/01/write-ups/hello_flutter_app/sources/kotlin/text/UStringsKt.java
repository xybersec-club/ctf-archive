...
public final class UStringsKt {
    ...
    public static final String m1340toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1342toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1341toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m1339toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final byte toUByte(String $this$toUByte) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m105unboximpl();
        }
    ...
    public static final short toUShort(String $this$toUShort) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m365unboximpl();
        }
    ...
    public static final int toUInt(String $this$toUInt) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m183unboximpl();
        }
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (uIntOrNull != null) {
            int m183unboximpl = uIntOrNull.m183unboximpl();
            if (UnsignedKt.uintCompare(m183unboximpl, UInt.m132constructorimpl(255)) > 0) {
                return null;
            }
            return UByte.m50boximpl(UByte.m56constructorimpl((byte) m183unboximpl));
        }
        return null;
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        if (uIntOrNull != null) {
            int m183unboximpl = uIntOrNull.m183unboximpl();
            if (UnsignedKt.uintCompare(m183unboximpl, UInt.m132constructorimpl(SupportMenu.USER_MASK)) > 0) {
                return null;
            }
            return UShort.m310boximpl(UShort.m316constructorimpl((short) m183unboximpl));
        }
        return null;
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        for (int i = start; i < length; i++) {
            ...
            if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                ...
                limitBeforeMul = UnsignedKt.m385uintDivideJ1ME1BU(-1, uradix);
                if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                    return null;
                }
            }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m210constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                if (limitBeforeMul == 512409557603043100L) {
                    limitBeforeMul = UnsignedKt.m387ulongDivideeb3DHEI(-1L, uradix);
                    if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                        return null;
                    }
                } else {
            ...
            long result2 = ULong.m210constructorimpl(result * uradix);
            result = ULong.m210constructorimpl(ULong.m210constructorimpl(UInt.m132constructorimpl(digit) & KeyboardMap.kValueMask) + result2);
        ...
        return ULong.m204boximpl(result);
    }
}
