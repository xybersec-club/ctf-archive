...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    public final int m1267getFirstpVg5ArA() {
        return this.first;
    }

    /* renamed from: getLast-pVg5ArA  reason: not valid java name */
    public final int m1268getLastpVg5ArA() {
        return this.last;
    }
    ...
    public String toString() {
        ...
        int i;
        if (this.step > 0) {
            append = new StringBuilder().append((Object) UInt.m177toStringimpl(this.first)).append("..").append((Object) UInt.m177toStringimpl(this.last)).append(" step ");
            i = this.step;
        } else {
            append = new StringBuilder().append((Object) UInt.m177toStringimpl(this.first)).append(" downTo ").append((Object) UInt.m177toStringimpl(this.last)).append(" step ");
            i = -this.step;
        }
