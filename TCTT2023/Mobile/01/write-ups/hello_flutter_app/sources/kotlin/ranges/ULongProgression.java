...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public final long m1274getFirstsVKNKU() {
        return this.first;
    }

    /* renamed from: getLast-s-VKNKU  reason: not valid java name */
    public final long m1275getLastsVKNKU() {
        return this.last;
    }
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + (((((int) ULong.m210constructorimpl(j ^ ULong.m210constructorimpl(j >>> 32))) * 31) + ((int) ULong.m210constructorimpl(j2 ^ ULong.m210constructorimpl(j2 >>> 32)))) * 31);
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            append = new StringBuilder().append((Object) ULong.m255toStringimpl(this.first)).append("..").append((Object) ULong.m255toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            append = new StringBuilder().append((Object) ULong.m255toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m255toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
