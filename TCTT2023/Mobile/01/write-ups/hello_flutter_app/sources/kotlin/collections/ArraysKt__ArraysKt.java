        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m604contentEqualskV0jMPg(((UByteArray) t).m122unboximpl(), ((UByteArray) t2).m122unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m601contentEqualsFGO6Aew(((UShortArray) t).m382unboximpl(), ((UShortArray) t2).m382unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m602contentEqualsKJPZfPQ(((UIntArray) t).m200unboximpl(), ((UIntArray) t2).m200unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m606contentEqualslec5QzE(((ULongArray) t).m278unboximpl(), ((ULongArray) t2).m278unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder result, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                result.append(UArraysKt.m618contentToString2csIQuQ(uByteArray != null ? uByteArray.m122unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                result.append(UArraysKt.m622contentToStringd6D3K8(uShortArray != null ? uShortArray.m382unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                result.append(UArraysKt.m621contentToStringXUkPCBk(uIntArray != null ? uIntArray.m200unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                result.append(UArraysKt.m624contentToStringuLth9ew(uLongArray != null ? uLongArray.m278unboximpl() : null));
            } else {
