...
public final class CancellableKt {
    public static final <T> void startCoroutineCancellable(Function1<? super Continuation<? super T>, ? extends Object> function1, Continuation<? super T> continuation) {
        try {
            ...
            DispatchedContinuationKt.resumeCancellableWith$default(intercepted, Result.m38constructorimpl(Unit.INSTANCE), null, 2, null);
    ...
    public static final <R, T> void startCoroutineCancellable(Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r, Continuation<? super T> continuation, Function1<? super Throwable, Unit> function1) {
        try {
            ...
            Result.Companion companion = Result.Companion;
            DispatchedContinuationKt.resumeCancellableWith(intercepted, Result.m38constructorimpl(Unit.INSTANCE), function1);
        } catch (Throwable e$iv) {
            dispatcherFailure(continuation, e$iv);
        }
    }
    ...
    public static final void dispatcherFailure(Continuation<?> continuation, Throwable e) {
        Result.Companion companion = Result.Companion;
        continuation.resumeWith(Result.m38constructorimpl(ResultKt.createFailure(e)));
        throw e;
    }
}
