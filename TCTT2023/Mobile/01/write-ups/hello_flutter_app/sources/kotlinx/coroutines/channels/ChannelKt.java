...
public final class ChannelKt {
    ...
    public static final <T> T m1530getOrElseWpGqRn0(Object $this$getOrElse, Function1<? super Throwable, ? extends T> function1) {
        return $this$getOrElse instanceof ChannelResult.Failed ? function1.invoke(ChannelResult.m1538exceptionOrNullimpl($this$getOrElse)) : $this$getOrElse;
    }

    /* renamed from: onSuccess-WpGqRn0 */
    public static final <T> Object m1533onSuccessWpGqRn0(Object $this$onSuccess, Function1<? super T, Unit> function1) {
    ...
    public static final <T> Object m1532onFailureWpGqRn0(Object $this$onFailure, Function1<? super Throwable, Unit> function1) {
        if ($this$onFailure instanceof ChannelResult.Failed) {
            function1.invoke(ChannelResult.m1538exceptionOrNullimpl($this$onFailure));
        }
        return $this$onFailure;
    }

    /* renamed from: onClosed-WpGqRn0 */
    public static final <T> Object m1531onClosedWpGqRn0(Object $this$onClosed, Function1<? super Throwable, Unit> function1) {
        if ($this$onClosed instanceof ChannelResult.Closed) {
            function1.invoke(ChannelResult.m1538exceptionOrNullimpl($this$onClosed));
        }
