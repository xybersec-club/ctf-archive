...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m1552catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt__ErrorsKt.m1559catch(flow, function3);
    }
    ...
    public static final <T> Flow<T> m1553debounceHG0u8IE(Flow<? extends T> flow, long timeout) {
        return FlowKt__DelayKt.m1555debounceHG0u8IE(flow, timeout);
    }
    ...
    public static final <T> Flow<T> m1554sampleHG0u8IE(Flow<? extends T> flow, long period) {
        return FlowKt__DelayKt.m1556sampleHG0u8IE(flow, period);
    }
