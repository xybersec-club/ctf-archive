...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    public void invokeOnClose(Function1<? super Throwable, Unit> function1) {
        ...
        Object state = this._state;
        if ((state instanceof Closed) && SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, function1, AbstractChannelKt.HANDLER_INVOKED)) {
    ...
    public Object mo1529trySendJP2dKIU(E e) {
        Closed it = offerInternal(e);
        if (it != null) {
            return ChannelResult.Companion.m1547closedJP2dKIU(it.getSendException());
        }
