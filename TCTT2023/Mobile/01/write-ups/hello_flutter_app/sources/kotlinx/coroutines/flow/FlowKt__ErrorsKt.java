...
public final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    /* renamed from: catch */
    public static final <T> Flow<T> m1559catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
    ...
    public static final <T> Flow<T> onErrorCollect(Flow<? extends T> flow, Flow<? extends T> flow2, Function1<? super Throwable, Boolean> function1) {
        return FlowKt.m1552catch(flow, new FlowKt__ErrorsKt$onErrorCollect$2(function1, flow2, null));
    }
    ...
    */
    public static final <T> java.lang.Object catchImpl(kotlinx.coroutines.flow.Flow<? extends T> r6, kotlinx.coroutines.flow.FlowCollector<? super T> r7, kotlin.coroutines.Continuation<? super java.lang.Throwable> r8) {
        ...
        L38:
            ...
            r2.<init>()
            r3 = 0
            kotlinx.coroutines.flow.FlowKt__ErrorsKt$catchImpl$$inlined$collect$1 r4 = new kotlinx.coroutines.flow.FlowKt__ErrorsKt$catchImpl$$inlined$collect$1     // Catch: java.lang.Throwable -> L5b
            r4.<init>(r7, r2)     // Catch: java.lang.Throwable -> L5b
            kotlinx.coroutines.flow.FlowCollector r4 = (kotlinx.coroutines.flow.FlowCollector) r4     // Catch: java.lang.Throwable -> L5b
            r8.L$0 = r2     // Catch: java.lang.Throwable -> L5b
            r5 = 1
            r8.label = r5     // Catch: java.lang.Throwable -> L5b
            java.lang.Object r4 = r6.collect(r4, r8)     // Catch: java.lang.Throwable -> L5b
            if (r4 != r1) goto L56
            return r1
        L56:
            r7 = r2
